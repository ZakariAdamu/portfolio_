...
export function ProfileImage({
	...
	// === the chatbot sidebar logic is commented out, I don't want to remove it yet ===
	...
	return (
		...
		>
			...
			{/* Hover Overlay */}
			<div
				className={`absolute inset-0 backdrop-blur-0 flex items-center justify-center transition-opacity duration-300 ${
