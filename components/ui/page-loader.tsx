					...
					<div className="relative text-center space-y-8 px-4">
						...
						<div className="flex justify-center">
							<div className="relative">
								<div className="absolute inset-0 bg-gradient-to-r from-purple-900 via-slate-800 to-slate-500 rounded-full blur-2xl opacity-50 animate-spin-slow" />
						...
						>
							<h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-800 via-slate-800 to-slate-500 bg-clip-text text-transparent animate-gradient">
								Welcome!
							</h1>
						...
						<div className="w-full max-w-md mx-auto space-y-2">
							<div className="h-2 bg-white/10 rounded-full overflow-hidden backdrop-blur-xl">
								<div
									className="h-full bg-gradient-to-r from-purple-800 via-slate-800 to-slate-500 rounded-full transition-all duration-300 ease-out"
						...
						<div className="flex justify-center gap-2">
							<div
								className="w-3 h-3 bg-purple-800 rounded-full animate-bounce"
								style={{ animationDelay: "0s" }}
							/>
							<div
								className="w-3 h-3 bg-slate-800 rounded-full animate-bounce"
